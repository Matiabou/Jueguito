class Jugador
{
    ...
    public int clase { get; private set; }
    public int vida { get; set; }
    public int vidaMaxima { get; set; }
    public static int cantJugadores { get; private set; }
    public int[] movimientosEntero = new int[4], probabilidades = new int[9], daños = new int[9];
    public string[] movimientos = new string[4], movimientosDisponibles = new string[9];
    public bool[] protect = new bool[2], poison = new bool[3], bleed = new bool[3];
    public Jugador()
    {
        vida = 200;
        vidaMaxima = 200;
    ...
    public Jugador(string nombre, int clase, List<int> movimientos){
        this.nombre = nombre;
        this.clase = clase;
    ...
    {
        Jugador.cantJugadores = cantJugadores;
    }
